    ...
    <>
      <div className={styles.login_screen_form}>
        <div className={styles.signIn_form}>
          <h1 className={styles.form_heading}>Create account on Candela</h1>
          <div className={styles.sign_google_box}>
            <form>
              <button name="button" className={styles.sinin_with_google_btn}>
          ...
          <div className={styles.form_field}>
            <form onSubmit={signupSubmit}>
              ...
              <button type="submit" className={styles.sign_btn}>Sign Up</button>
            </form>
          </div>
          <div className='sign_up_text'>
            Already have an account? <Link href={'/login'} className={styles.signup_link_btn}>Sign In</Link>
          </div>
        </div>
      </div>
      <ToastContainer />
